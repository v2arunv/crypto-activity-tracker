...
* The original package name 'org.vv.crypto-activity-tracker.customer-api' is invalid and this project uses 'org.vv.cryptoactivitytracker.customerapi' instead.
...
```
$ docker run --rm customer-api:0.0.1-SNAPSHOT
```
...
```
$ build/native/nativeCompile/customer-api
```
